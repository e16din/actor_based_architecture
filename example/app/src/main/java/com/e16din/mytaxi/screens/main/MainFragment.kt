...
class MainFragment : Fragment(), DataKey {
        ...
        var lastLocation: Location? = null
            get() {
                val locationJson = sharedPreferences()
                    .getString(MyTaxiApp.KEY_LAST_LOCATION, "")
    ...
    inner class UserAgent {
        ...
        fun lookAtWaitingTimeLabel(waitingTimeMinutes: Int) {
        ...
        fun lookAtCarCharacteristics(characteristics: String) {
    ...
    inner class ServerAgent {
        private val httpClient = getApplication().httpClient()
