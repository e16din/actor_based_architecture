...
Я хотел делать приложения быстро, решать прикладные задачи относящиеся в первую очередь к функционалу приложения, а не возиться во всей этой тягомотине.
...
Особенно сложно приходится начинающим ребятам - куча фреймворков, аббревиатур, понятий в которые надо врубиться. Да еще надо все правильно понять и применить. 
...
(Я назвал ее - акторная архитектура)
...
Получается лаконичный ООП стиль в союзе с декларативным подходом.
...
- агенты акторов описывают реальные сущности(экран, приложение, пользователь, сервер, телефон) это легко понять человеку
